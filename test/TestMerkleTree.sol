...
contract TestMerkleTree
{
		...
		public
	{
		...
		uint256 leaf_0_root;
		uint256 leaf_0_offset;
		(leaf_0_root, leaf_0_offset) = tree1.Insert(leaf_0);
		Assert.equal(leaf_0_root, 1 + 5635502254919888512883611961327385811173415612631829359029947885796109426800, "Root for leaf 0 must match");
